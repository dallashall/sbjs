...
var _player = __webpack_require__(/*! ../player */ "./src/player/index.js");
...
var Board = function (_Component) {
  ...
  _createClass(Board, [{
    ...
    value: function move(dir) {
      ...
      return function (e) {
        e.preventDefault();
        var nextCoords = movements[dir](_this2.state);
        _this2.setState(nextCoords);
      };
    }
  }, {
    key: 'render',
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  (0, _reactDom.render)(_react2.default.createElement(_board2.default, { connection: new _socket2.default() }), root);
});
...
var Player = function Player(_ref) {
  var _ref$x = _ref.x,
      ...
      _ref$dir = _ref.dir,
      dir = _ref$dir === undefined ? 'D' : _ref$dir;
...
var Connection = function () {
  function Connection() {
    ...
    this.io = _socket2.default;
    this.socket = null;
  }

  _createClass(Connection, [{
    key: 'connect',
    value: function connect(query) {
